...
const ICONS = Object.freeze({
  ...
  hotel:[['path',{d:'M4 20V5.5h16V20'}],['path',{d:'M8 9h2M14 9h2M8 13h2M14 13h2M10 20v-3h4v3'}]],
  airbnb:[['path',{d:'M12 4c-1.7 0-2.5 2.3-3.4 4.5L5.8 15c-.8 1.8.2 3.5 2 3.5 1.4 0 2.8-1.2 4.2-3.3 1.4 2.1 2.8 3.3 4.2 3.3 1.8 0 2.8-1.7 2-3.5l-2.8-6.5C14.5 6.3 13.7 4 12 4Z'}],['circle',{cx:'12',cy:'12',r:'2.2'}]],
  ...
  ambulance:[['rect',{x:'3.5',y:'7.5',width:'12.5',height:'9.5',rx:'2'}],['path',{d:'M16 11h2.4l2.1 2.8V17H16'}],['path',{d:'M9.8 10v4.5M7.55 12.25h4.5'}],['circle',{cx:'8',cy:'18',r:'1.7'}],['circle',{cx:'18',cy:'18',r:'1.7'}]],
