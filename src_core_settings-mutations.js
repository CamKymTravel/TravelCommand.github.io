...
import { setAnnualBudgetForYear } from './src_core_budget.js';
...
export function saveGeneralSettingsDraft(state, fields = {}) {
  ...
  if (fields.annualBudgetYear != null && fields.annualBudgetYear !== '') setAnnualBudgetForYear(state.settings, fields.annualBudgetYear, annualBudgetAUD);
  else state.settings.annualBudgetAUD = annualBudgetAUD;
